...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/VoxImplantSDK/VoxImplantSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/VoxImplantWebRTC/VoximplantWebRTC.framework"
